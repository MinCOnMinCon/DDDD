...
public class StoryTextManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        switch (curSceneNum)
        {
            ...
            case 0:
                storyText.text ="위에서 엄청난 굉음이 울리고, 그 소리에 당신은 눈을 뜹니다.";
                ...
                break;
            case 1:
                storyText.text = "당신이 기사를 쓰러트린 후, 당신은 처음에 있던 장소로 돌아왔습니다.";
                ...
                break;
            case 2:
                storyText.text = "두 번의 연전으로 힘겨웠던 당신은 숨을 거칠게 내뱉으며 고서에게 다가갑니다.";
                ...
                break;
            case 3:
                storyText.text = "검을 잡은 손은 아려오지만, 당신은 어째선지 멈추면 안된다는 생각이 듭니다.";
                ...
                break;
            case 4:
                storyText.text = "당신은 더 이상 서있을 힘도 없어 바닥에 엎어졌습니다.";
                ...
                text.Add("당신의 뒤에서 나지막히 목소리가 들립니다.");
                text.Add("\"아직입니다.\"");
                text.Add("목소리를 듣고 뒤를 돌아보니, 검은 옷을 입은 여자를 보았습니다.");
                ...
                text.Add("\"하지만.. 조만간 올 겁니다.\"\n" + "그녀는 당신을 안아 올리며 말했습니다.");
    ...
    public void onButtonClicked()
    {
        ...
        else
        {
            ...
            {
                ResetStory();
                uiManager.GameoverConversion(false);
            }
            else
            {
                curIndex = 0;
                uiManager.CombatConversion(curSceneNum);
                curSceneNum++;
            }
